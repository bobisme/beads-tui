...
This project uses BotBus for agent coordination when multiple agents are active. Before starting work, check for other agents and active claims.
...
botbus check-claim src/ui/list.rs   # Before editing
